    ...
    return (
        ...
        <div className='register__conatainer'>
             ...
             {/* <div className='register__img'>
              ...
              <h3>Register Form</h3>
            <input type="text" id="username" onChange={updateData} value={formdata.username} placeholder="Enter Roll Number"/>

            <input type="email" id="password" onChange={updateData} value={formdata.password} placeholder="Enter Email" /><br></br>
